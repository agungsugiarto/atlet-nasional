      ...
      <div class="row">
        <aside class="col-xs-12 col-md-3 col-md-push-9">
          <div class="js-aside-menu">
            <h2 class="u-mb-25">Search</h2>
            <form id="search-form" class="form search-form u-mb-25" method="" action="#">
              <label class="search-form__input">
              Search in blog posts
                <input type="text" name="request" value="" placeholder="Keyword" required>
              </label>
              <label class="search-form__submit">
                <input class="visuallyhidden" type="submit" name="submit" value="">
              </label>
            </form>
            <h2 class="u-mb-25">Cabang Olahraga</h2>
            <div class="sorting-panel t-aside-panel">
              <ul>
                <li class="sorting-panel__item"><a class="sorting-panel__link sorting-panel--active" href="<?php echo base_url();?>home/cabangolahraga">Lihat Semua</a><span>86</span></li>
                <!-- View data cabor -->
                <?php
                foreach ($cabor as $view_cabor) {
                ?>
                <li class="sorting-panel__item"><a class="sorting-panel__link" href="#"><?php echo $view_cabor->nama_cabor ?></a><span>10</span></li>
                <?php  }  ?>
                <!-- End View data cabor -->
              </ul>
            </div>
