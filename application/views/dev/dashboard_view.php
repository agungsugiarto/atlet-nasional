...
<html>
  <head>
    ...
    <title>Atlet Nasional | Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo base_url('dev/dashboard'); ?>" class="logo">
          ...
          <span class="logo-lg"><b>Atlet Nasional</b></span>
        </a>
      ...
      <footer class="main-footer">
        <div class="pull-right hidden-xs">
          ...
          <strong>Copyright &copy; 2016 <a href="#">atletnasional.com</a>.</strong> All rights reserved.
      </footer>
