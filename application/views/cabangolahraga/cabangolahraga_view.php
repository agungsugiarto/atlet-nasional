  ...
  <section class="container   js-sorting-panel">
    <div class="index-layout__services">
      ...
      <div class="sorting-panel text-center">
        <ul>
          <li><a href="#" data-sorting-btn="all" class="sorting-panel--active"><h4>All</h4></a></li>
          <?php
          foreach ($cabor as $view_cabor) {
          ?>
          <li><a href="#" data-sorting-btn="<?php echo $view_cabor->nama_cabor ?>"><h4><?php echo $view_cabor->nama_cabor ?></h4></a></li>
          <?php  }  ?>
